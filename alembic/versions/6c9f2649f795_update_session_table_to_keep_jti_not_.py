"""update session table to keep jti not refresh token due to security reasons

Revision ID: 6c9f2649f795
Revises: a0651253187c
Create Date: 2026-03-02 16:04:37.823080
...
revision: str = '6c9f2649f795'
down_revision: Union[str, Sequence[str], None] = 'a0651253187c'
...
def upgrade() -> None:
    ...
    op.add_column('sessions', sa.Column('jti', sa.String(), nullable=False))
